...
<div class="header ">
        <nav class="navbar navbar-expand-sm navbar-dark mybg" >
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php?control=home&page=1">TABATO</a>
                ...
                <div class="collapse navbar-collapse" id="mynavbar">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php if($nav=='lienhe') {echo 'active';} ?>" href="lienhe.php?control=lienhe">Liên Hệ</a>
                        </li>
                    </ul>
